...
public class ReportController {
    ...
    public ResponseEntity<ReportDTO> createReport(
        ...
        ReportDTO report = reportService.createReport(storeId, userId, reportDTO.getTitle(), reportDTO.getDescription(), reportDTO.getReportDate(), null);
    ...
    public ResponseEntity<ReportDTO> updateReport(
        ...
        ReportDTO updatedReport = reportService.updateReport(reportId, finalTitle, finalDescription, finalDate, null);
